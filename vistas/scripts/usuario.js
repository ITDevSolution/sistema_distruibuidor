...
function init() {
  ...
  $.post("../ajax/usuario.php?op=permisos&id=", function (r) {
    $("#permisos").html(r)
    // console.log($("#permisos").html(r))
  })

  //Mostramos las zonas
  $.post("../ajax/usuario.php?op=zonas&id=", function (r) {
    $("#zonas").html(r)
    $("#zonas").selectpicker("render")
  })
...
function mostrar(idusuario) {
  ...
  $.post("../ajax/usuario.php?op=zonas&id=" + idusuario, function (r) {
    $("#zonas").html(r)
    $("#zonas").selectpicker("render")
  })
}
