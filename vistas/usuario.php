              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Usuario y Vendedores <button class="btn btn-success" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Agregar</button> <a href="../reportes/rptusuarios.php" target="_blank"><button class="btn btn-info"><i class="fa fa-clipboard"></i> Reporte</button></a></h1>
                    ...
                    <div class="panel-body" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          ...
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <label>Zonas:</label>
                            <select class="selectpicker" multiple data-live-search="true" id="zonas" name="zona[]">
                            </select>
                          </div>
