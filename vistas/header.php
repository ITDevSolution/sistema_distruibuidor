    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="#" class="logo">
          ...
          <span class="logo-lg"><b>CENTHERPLAST</b></span>
        </a>
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                    <?php $name = explode(" ", $_SESSION['nombre']); ?>
                      <?php echo $name[0].'-'.$_SESSION['cargo']; ?>
                      
                    
                      <small>https://www.facebook.com/Centherplast</small>
                    </p>
                  </li>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">       
          ...
          <ul class="sidebar-menu">
            ...
            {
              echo '<li id="mConsultaVendedor">
              <a href="zonasclientesporvendedor.php">
                <i class="fa fa-tasks"></i> <span>Consulta Vendedores</span>
              </a>
            </li>';
            }
            ?>
            ...
            {
              echo '<li id="mClientes" class="treeview">
              <a href="#">
            ...
            if ($_SESSION['zonas']==1)
            {
              echo '<li id="mZonas" class="treeview">
                      <a href="#">
                        <i class="fa fa-th"></i>
                        <span>Gestion de Zonas</span>
                        <i class="fa fa-angle-left pull-right"></i>
                      </a>
                    <ul class="treeview-menu">
                      <li id="lZonas"><a href="zona.php"><i class="fa fa-circle-o"></i> Zonas</a></li>
                      <li id="lFrecuencias"><a href="frecuencia.php"><i class="fa fa-circle-o"></i> Frecuencia</a></li>
                    </ul>
                  </li>';
            }
            ?>
            ...
            if ($_SESSION['acceso']==1)
            {
              ...
              <ul class="treeview-menu">
                <li id="lUsuarios"><a href="usuario.php"><i class="fa fa-circle-o"></i> Usuarios y Vendedores</a></li>
